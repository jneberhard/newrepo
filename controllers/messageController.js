...
mesCont.buildMessageForm = async function (req, res, next) {
  ...
  res.render("message/message", {
    ...
    error: req.flash("error"),
      ...
      console.error("buildMessageForm error:", error)
        next(error)
    }
}
...
mesCont.buildInbox = async function (req, res, next) {
    try {
        ...
        console.error("buildInbox error:", error)
        next(error)
    }
}
...
mesCont.buildSent = async function (req, res, next) {
    try {
        ...
        console.error("buildSent error", error)
        next(error)
    }
}
...
mesCont.buildReplyForm = async function (req, res, next) {
    try {
        ...
        console.error("buildReplyForm error:", error)
        next(error)
    }
}
